...
func (ec *executionContext) field_Shop_runtimes_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["id"]; ok {
		arg0, err = ec.unmarshalORuntime2ᚖgithubᚗcomᚋsuhayᚋsandwichᚑshopᚐRuntime(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Order_runtime(ctx context.Context, field graphql.CollectedField, obj *Order) (ret graphql.Marshaler) {
	...
	rctx.Result = res
	ctx = ec.Tracer.StartFieldChildExecution(ctx)
	return ec.marshalORuntime2ᚖgithubᚗcomᚋsuhayᚋsandwichᚑshopᚐRuntime(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_GetOrder(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().GetOrder(rctx, args["name"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Shop_runtimes(ctx context.Context, field graphql.CollectedField, obj *Shop) (ret graphql.Marshaler) {
	...
	rctx.Result = res
	ctx = ec.Tracer.StartFieldChildExecution(ctx)
	return ec.marshalORuntime2ᚕᚖgithubᚗcomᚋsuhayᚋsandwichᚑshopᚐRuntime(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalOOrder2ᚖgithubᚗcomᚋsuhayᚋsandwichᚑshopᚐOrder(ctx context.Context, sel ast.SelectionSet, v *Order) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._Order(ctx, sel, v)
...
func (ec *executionContext) unmarshalORuntime2githubᚗcomᚋsuhayᚋsandwichᚑshopᚐRuntime(ctx context.Context, v interface{}) (Runtime, error) {
	var res Runtime
	return res, res.UnmarshalGQL(v)
}

func (ec *executionContext) marshalORuntime2githubᚗcomᚋsuhayᚋsandwichᚑshopᚐRuntime(ctx context.Context, sel ast.SelectionSet, v Runtime) graphql.Marshaler {
	return v
}

func (ec *executionContext) unmarshalORuntime2ᚕᚖgithubᚗcomᚋsuhayᚋsandwichᚑshopᚐRuntime(ctx context.Context, v interface{}) ([]*Runtime, error) {
	var vSlice []interface{}
	if v != nil {
		if tmp1, ok := v.([]interface{}); ok {
			vSlice = tmp1
	...
	for i := range vSlice {
		res[i], err = ec.unmarshalORuntime2ᚖgithubᚗcomᚋsuhayᚋsandwichᚑshopᚐRuntime(ctx, vSlice[i])
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) marshalORuntime2ᚕᚖgithubᚗcomᚋsuhayᚋsandwichᚑshopᚐRuntime(ctx context.Context, sel ast.SelectionSet, v []*Runtime) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	ret := make(graphql.Array, len(v))
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalORuntime2ᚖgithubᚗcomᚋsuhayᚋsandwichᚑshopᚐRuntime(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) unmarshalORuntime2ᚖgithubᚗcomᚋsuhayᚋsandwichᚑshopᚐRuntime(ctx context.Context, v interface{}) (*Runtime, error) {
	if v == nil {
		return nil, nil
	}
	res, err := ec.unmarshalORuntime2githubᚗcomᚋsuhayᚋsandwichᚑshopᚐRuntime(ctx, v)
	return &res, err
}

func (ec *executionContext) marshalORuntime2ᚖgithubᚗcomᚋsuhayᚋsandwichᚑshopᚐRuntime(ctx context.Context, sel ast.SelectionSet, v *Runtime) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return v
